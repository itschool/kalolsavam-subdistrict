...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
	...
	<tr>
		...
		<td align="left" width="30%" class="table_row_first">
			...
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_1", @$items_selected[0]['item_code'], 'class="input_box_small" id="txtItemCode_1" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_1\',\'txtItemCode_2\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_2", @$items_selected[1]['item_code'], 'class="input_box_small" id="txtItemCode_2" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_2\',\'txtItemCode_3\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_3", @$items_selected[2]['item_code'], 'class="input_box_small" id="txtItemCode_3" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_3\',\'txtItemCode_4\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_4", @$items_selected[3]['item_code'], 'class="input_box_small" id="txtItemCode_4" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_4\',\'txtItemCode_5\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_5", @$items_selected[4]['item_code'], 'class="input_box_small" id="txtItemCode_5" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_5\',\'txtItemCode_6\',3);" maxlength="3"').'</div></div>';
			echo '<div class="clear_both"></div><div class="teachersTextBox" style=" float:left">';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_6", @$items_selected[5]['item_code'], 'class="input_box_small" id="txtItemCode_6" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_6\',\'txtItemCode_7\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_7", @$items_selected[6]['item_code'], 'class="input_box_small" id="txtItemCode_7" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_7\',\'txtItemCode_8\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_8", @$items_selected[7]['item_code'], 'class="input_box_small" id="txtItemCode_8" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_8\',\'txtItemCode_9\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_9", @$items_selected[8]['item_code'], 'class="input_box_small" id="txtItemCode_9" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_9\',\'txtItemCode_10\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_10", @$items_selected[9]['item_code'], 'class="input_box_small" id="txtItemCode_10" onkeypress="javascript:return numbersonly(this, event, false);" onKeyUp="javascript:change_text_max_to_focus(\'txtItemCode_10\',\'txtPinnanyCode_1\',3);" maxlength="3"').'</div></div>';
			?>
		</td>
		...
		<td align="left" width="30%" class="table_row_first">
			...
			echo '<div class="clear_both"></div><div class="teachersTextBox">';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtPinnanyCode_1", @$pinnany_selected[0]['item_code'], 'class="input_box_small" id="txtPinnanyCode_1" onKeyUp="javascript:change_text_max_to_focus(\'txtPinnanyCode_1\',\'txtPinnanyCode_2\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtPinnanyCode_2", @$pinnany_selected[1]['item_code'], 'class="input_box_small" id="txtPinnanyCode_2" onKeyUp="javascript:change_text_max_to_focus(\'txtPinnanyCode_2\',\'txtPinnanyCode_3\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtPinnanyCode_3", @$pinnany_selected[2]['item_code'], 'class="input_box_small" id="txtPinnanyCode_3" onKeyUp="javascript:change_text_max_to_focus(\'txtPinnanyCode_3\',\'txtPinnanyCode_4\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtPinnanyCode_4", @$pinnany_selected[3]['item_code'], 'class="input_box_small" id="txtPinnanyCode_4" onKeyUp="javascript:change_text_max_to_focus(\'txtPinnanyCode_4\',\'txtPinnanyCode_5\',3);" maxlength="3"').'</div>';
			echo '<div style="margin-left:5px; float:left">'.form_input("txtPinnanyCode_5", @$pinnany_selected[4]['item_code'], 'class="input_box_small" id="txtPinnanyCode_5" onKeyUp="javascript:change_text_max_to_focus(\'txtPinnanyCode_5\',\'update_participant\',3);" maxlength="3"').'</div></div>';
			?>
		</td>
	</tr>
	<tr>
