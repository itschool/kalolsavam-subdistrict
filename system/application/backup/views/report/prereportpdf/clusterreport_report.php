...
<tr>
    ...
    <td height="27" align="center" class="style2"  style="border: 0 0px 1px 0 #666666;">Cluster :<?php echo $value['cluster_no']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
    <td height="27"  align="center" class="style3"  style="border: 0 0px 1px 0 #666666;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registration No. of Participants&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <?php
   ...
   ?>
    <tr>
    <td width="27%" align="center"  style="border: 0 0px 1px 0 #666666;" colspan="2"><?php echo $value['participant_id']; ?></td>
