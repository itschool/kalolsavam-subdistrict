...
<table width="102%" style="width: 100%;">
  ...
  <tr>
    <td align="center" class="style2"  style="border: 0 0px 1px 0 #666666;" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sl.No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="style2"  height="25" style="border: 0 0px 1px 0 #666666;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registration No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="style2"  height="25" style="border: 0 0px 1px 0 #666666;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cluster&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="style2"  height="25" style="border: 0 0px 1px 0 #666666;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Code No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="23%" align="center" class="style2"  height="25" style="border: 0 0px 1px 0 #666666;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Signature  of Participant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="14%" align="center" class="style2"  height="25" style="border: 0 0px 1px 0 #666666;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarks&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
   <?php
   $s=0;
   if(count($fees_details)>0){
		...
		?>
  <tr>
    <td  align="center" style="border: 0 0px 1px 0 #666666;"><?php echo $s; ?></td>
    <td  align="center" style="border: 0 0px 1px 0 #666666;"><?php echo $fees_details[$j]['participant_id']; ?> </td>
    <td  align="center" style="border: 0 0px 1px 0 #666666;"><?php echo $fees_details[$j]['cluster_no']; ?></td>
    <td width="17%"  style="border: 0 0px 1px 0 #666666;">&nbsp;</td>
    <td style="border: 0 0px 1px 0 #666666;">&nbsp;</td>
    <td style="border: 0 0px 1px 0 #666666;">&nbsp;</td>
  </tr>
  <? } 
	  }
