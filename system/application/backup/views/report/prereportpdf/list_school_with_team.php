	...
	?>
	    ...
	    <table width="100%" border="1" bordercolor="#666666" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
          <tr >
            ...
            <th width="150" align="left" class="style2" style="border-bottom:1px #666666; border-right:1px #666666; padding:2px;">School</th>
            <th width="150" align="left" class="style2" style="border-bottom:1px #666666; border-right:1px #666666; padding:2px;">Principal</th>
            <th width="150" align="left" class="style2" style="border-bottom:1px #666666; border-right:1px #666666; padding:2px;">Headmster</th>
            <th width="150" align="left" class="style2" style="border-bottom:1px #666666;">Team Manager</th>
          </tr>
          <?php
		  	$count = 1;
