...
<page_footer>
  ...
  <tr>
   ...
   <td width="40" align="center" class="style2" style="border-right:1px #666666; padding:2px;">Adm.No.</td>
    ...
    <td width="30" align="center" class="style2" style="border-right:1px #666666; padding:2px;">Cluster</td>
    <td width="56" align="center" class="style2" style="border-right:1px #666666; padding:2px;">Stage No</td>
  ...
  <tr>
    ...
    <td class="ety" align="left"  style="border-top:1px #666666; border-right:1px #666666; padding:2px;"><?php echo wordwrap($part_details[$j]['item_code'].' - '.$part_details[$j]['item_name'],30,'<br>');?></td>
    <td class="ety" align="left"  style="border-top:1px #666666; border-right:1px #666666; padding:2px;" ><?php echo wordwrap($part_details[$j]['participant_name'],25,'<br>')?></td>
    ...
    <td class="ety"  align="center"  style="border-top:1px #666666; border-right:1px #666666; padding:2px;" ><?php echo  $part_details[$j]['cluster_no']; ?></td>
    <td class="ety" align="center" style="border-top:1px #666666; border-right:1px #666666; padding:2px;"><?php echo $part_details[$j]['stage_name']; //stage_desc?></td>
    <td class="ety" align="left"  style="border-top:1px #666666; border-right:0px #666666; padding:2px;"><?php echo  $datt; ?></td>
