...
<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
  	<td colspan="6" style="border-bottom:1px #666666; padding:2px;">
    	<table align="center" width="100%" border="0">
        	<tr>
                <td class="style2" align="left" width="150">Stage No : <?php echo $fees_details[0]['stage_name']; ?></td>
  ...
  <tr>
    ...
    <td align="center" class="style2"  height="25" style="border-right:1px #666666; padding:2px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cluster&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <td width="14%" align="center" class="style2"  height="25" style="border-right:0px #666666; padding:2px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarks&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
   <?php
   ...
   if(count($fees_details)>0){
		...
		?>
  <tr>
    <td  align="center" style="border-top:1px #666666; border-right:1px #666666; padding:2px;" height="35"><?php echo $s; ?></td>
    ...
    <td   align="center" style="border-top:1px #666666; border-right:1px #666666; padding:2px;"><?php echo $fees_details[$j]['cluster_no']; ?></td>
    <td  width="17%" style="border-top:1px #666666; border-right:1px #666666; padding:2px;">&nbsp;</td>
