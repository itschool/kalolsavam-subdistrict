...
if ($this->session->userdata('SUB_DISTRICT'))
	...
	if (count($fest_master_details) > 0)
	{
		...
		$file_path	=	'';
		if (file_exists($this->config->item('base_path').'uploads/sub_district/'.$logo))
		{
			$file_path		=	base_url(false).'uploads/sub_district/'.$logo;
		}
	}
...
<table align="left" width="50%" border="1"><tr><td class="style56" colspan="2" >Kerala School Kalolsavam 2009-10</td></tr>
     <tr>
    	<td height="40">
        	<?php if ($file_path){?>
    ...
    <tr bgcolor="#CCCCCC">
    	<td bgcolor="#E5E5E5" colspan="2" align="center" class="style2" style="border-bottom:1px #666666;border-top:1px #666666; border-right:0px #666666; padding:2px;">Participants Card</td>
    </tr>
    <tr>
    	<td colspan="2">&nbsp;</td>
    </tr>
    ...
    <tr>
    	<td  width="50"class="style1" valign="top" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;" align="center"><?php echo $partcard[$k]['participant_id']; ?></td>
    	<td style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;"><span class="style2"><?php echo $partcard[$k]['participant_name']; ?></span><br>
    ...
    <tr>
        <td colspan="2" class="style9" valign="top" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;">
            &nbsp;&nbsp;&nbsp;&nbsp;<?php echo 'Cluster '.$partcard[$k]['cluster_no'].' :&nbsp;&nbsp; '.$partcard[$k]['stage_name'].'&nbsp; :  on  '.$dat_itme;?>
        </td>
    </tr>
    <?php
    }
...
<tr><td  width="50"class="style1" valign="top" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;" align="center"><?php //echo $partcard[$k]['participant_id']; ?></td>
<td style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;"></td></tr>
<?php
//}
...
<tr><td colspan="2" class="style9" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;">
&nbsp;&nbsp;&nbsp;&nbsp;<?php //echo 'Cluster '.$partcard[$k]['cluster_no'].' :&nbsp;&nbsp; '.$partcard[$k]['stage_name'].'&nbsp; :  on  '.$dat_itme;?>
</td>  </tr>
...
<tr><td>Reg. No</td><td>&nbsp;</td></tr>
<tr><td  width="50"class="style1" valign="top" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;" align="center">
<?php //echo $partcard[0]['participant_id']; ?></td>
<td style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;">
...
<tr><td colspan="2" class="style9" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<?php
