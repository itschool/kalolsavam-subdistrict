    	...
    	<td valign="top">
            ...
            <table border="1" width="275" >
                ...
                <?php
                 ...
                 <?php } 
                  ...
                  <td rowspan="2">&nbsp; </td>
                  <?php } ?>
                  <td  class="style56" >Kerala School Kalolsavam 2009-10</td>
              </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td rowspan="2" style="border-bottom:1px #666666; border-left:1px #666666; padding:1px;"><span class="style2">&nbsp;<?php echo wordwrap($participant_details[$i]['participant_name'],30,'<br/>'); ?></span><br>
                        &nbsp;<?php  echo $participant_details[$i]['school_code'].'  '.@$participant_details[0]['school_name']; ?><br>
                ...
                <tr>
                    <td colspan="2" class="<?php echo $style; ?>" valign="top" align="right">
                        <?php echo 'Cluster '.$item['cluster_no'].' :&nbsp;&nbsp; '.$item['stage_name'].'&nbsp; :  on  '.$dat_itme;?>
                   &nbsp;&nbsp;&nbsp; </td>
                </tr>
                <?php
				$l++;
         ...
         <td valign="top">
        	...
        	<table border="1" width="275" >
                ...
                <tr>
                    <td align="center">Reg. No</td>
                    <td rowspan="2" style="border-bottom:1px #666666; border-left:1.5px #666666; padding:2px;"><span class="style2"><?php echo wordwrap($participant_details[$i]['participant_name'],30,'<br/>'); ?></span><br>
                        <?php  echo $participant_details[$i]['school_code'].'  '.@$participant_details[0]['school_name']; ?><br>
                        <?php echo 'Class  :'.$participant_details[$i]['class']; ?>
                  </td>
                </tr>
