...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td class="tb" width='30'  align="center" style=" border-bottom:1px #666666; border-right:1px #666666; padding:2px;">B/G</td>
        <td class="tb"  width='40'  align="center" style=" border-bottom:1px #666666; border-right:1px #666666; padding:2px;">Class</td>
    ...
    <tr>
        ...
        <td class="ety"  align="center" style=" border-bottom:1px #666666; border-right:1px #666666; padding:2px;"><?php echo $itempart[$j]['participant_id'];?></td>
        ...
        <td class="ety" align="center" style=" border-bottom:1px #666666; border-right:1px #666666; padding:2px;"><?php echo $itempart[$j]['gender'];?></td>                  
        <td class="ety" align="center" style=" border-bottom:1px #666666; border-right:1px #666666; padding:2px;"><?php echo $itempart[$j]['class'];?></td>
