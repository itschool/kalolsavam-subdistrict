 ...
 <table align="left" width="275" border="1" >
	...
	?>
       ...
       <?php } ?>
       		 ...
       		 <td align="center" class="style56">Kerala School Kalolsavam 2009-10</td>
    </tr>
    <tr>
  		 <td align="center" class="style2"><?php echo $title.'<br> '.$venue; ?><br></td>
     </tr>
      ...
      <tr bgcolor="#CCCCCC">
		...
		<tr>
            ...
            <td rowspan="2" style="border-bottom:1px #000000; border-left:1px #000000; padding:0px;"><span class="style2">&nbsp;<?php echo $partcard[0]['participant_name']; ?></span><br>
				...
				&nbsp;<?php echo 'Class  :'.$partcard[0]['class']; ?></td>
   </tr>
		<tr>
	   ...
	   <tr>
     	 ...
     	 <tr>
      		<td align="right" colspan="2" class="style9" style="border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php echo 'Cluster '.$partcard[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard[$j]['stage_name'].'&nbsp; :  on  '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
   	 	</tr>
  			<?php
			}
			else{
   	 ...
   	 <tr>
    		<td colspan="2" class="style55" align="right"><?php echo 'Cluster '.$partcard[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard[$j]['stage_name'].'&nbsp; : on '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
      ...
      <tr bgcolor="#CCCCCC">
		...
		<tr>
            ...
            <td rowspan="2" style="border-bottom:1px #000000; border-left:1px #000000; padding:0px;"><span class="style2">&nbsp;<?php echo $partcard1[0]['participant_name']; ?></span><br>
				...
				&nbsp;<?php echo 'Class  :'.$partcard1[0]['class']; ?></td>
   </tr>
		<tr>
	   ...
	   <tr>
     	 ...
     	 <tr>
      		<td align="right" colspan="2" class="style9" style="border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php echo 'Cluster '.$partcard1[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard1[$j]['stage_name'].'&nbsp; :  on  '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
   	 	</tr>
  			<?php
			}
			else{
   	 ...
   	 <tr>
    		<td colspan="2" class="style55" align="right"><?php echo 'Cluster '.$partcard1[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard1[$j]['stage_name'].'&nbsp; : on '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
      ...
      <tr bgcolor="#CCCCCC">
		...
		<tr>
            ...
            <td rowspan="2" style="border-bottom:1px #000000; border-left:1px #000000; padding:0px;"><span class="style2">&nbsp;<?php echo $partcard2[0]['participant_name']; ?></span><br>
				...
				&nbsp;<?php echo 'Class  :'.$partcard2[0]['class']; ?></td>
   </tr>
		<tr>
	   ...
	   <tr>
     	 ...
     	 <tr>
      		<td align="right" colspan="2" class="style9" style="border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php echo 'Cluster '.$partcard2[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard2[$j]['stage_name'].'&nbsp; :  on  '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
   	 	</tr>
  			<?php
			}
			else{
   	 ...
   	 <tr>
    		<td colspan="2" class="style55" align="right"><?php echo 'Cluster '.$partcard2[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard2[$j]['stage_name'].'&nbsp; : on '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
