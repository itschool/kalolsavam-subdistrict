...
<tr>
    ...
    <td colspan=6 align="center" class="style2" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'><?php echo $data['fest_name'];; ?></td>
  </tr>
    <tr>
     <td colspan=6 align="center" class="style2" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'   >Result Declared <?php echo $completed[$i]['cn'] ."/" . $totalitems[$k]['c']; ?> Items</td>
    </tr>
  <tr>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'width="50" rowspan="2" align="center" >Sl No</td>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'width="450" rowspan="2" align="left" >&nbsp;&nbsp;School</td>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'colspan="3" align="center" >Grade</td>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'width="50" rowspan="2" align="center">Point</td>
  </tr>
  <tr>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'width="30" align="center" >A</td>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'width="30" align="center">B</td>
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'width="30" align="center" >C</td>
  </tr>
  ...
  <tr>
   ...
   <td class="style4" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'align="center" ><?php echo $data['cnt']; ?></td>
  </tr>
  <?php
  		$agrade=0;
		$bgrade=0;
