...
<tr>
      ...
      <td width="40" align="center" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;'>Grade</td>
    ...
    <tr>
        ...
        <td align="left" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;' class="style2"><?php echo wordwrap($retvalue[$j]['item_code'].' - '.$retvalue[$j]['item_name'],30,'<br>');?></td>
        <td align="left" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;' class="style2"><?php echo wordwrap($retvalue[$j]['participant_name'],40,'<br>');?></td>
      	...
      	<td align="center" style='border: 0 0 0.5px 0.5px 0 #666666;  height:20px;' class="style2"><?php echo  $retvalue[$j]['grade']; ?></td>
