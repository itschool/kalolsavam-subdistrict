...
class Login_Model extends Model{
	...
	function save_chgpwd_details()
	{
		...
		{
			$user				=	$user_master->result_array();
			$sub_district_code	=	$user[0]['sub_district_code'];	
	...
	function changeKalolsavam($subdist,$sub_dist_name){
		
		$data['sub_dist_kalolsavam_name']          =  $sub_dist_name.'  Subdistrict Kalolsavam 2011 - 2012';
		$this->db->where('sub_district_code',$subdist);
		if($this->db->update('sub_dist_kalolsavam_master',$data))
			return true;
		else
			return false;
	}
