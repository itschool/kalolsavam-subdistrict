...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
    ...
    <?php 
		...
		for($i = 0; $i < $cnt_item_list; $i++)
		{
			...
			/*if($selected_item_list[$i]['rank']==1){
					$classname	=	'table_row_second';		
					echo "Firsteee"		;
				}
			else{
					$classname	=	'table_row_first';		
				}*/
				?>
    	<tr>
	...
	?>
			<tr>
                ...
                <?php $is_confirm_to_print	=	'_blank';?>
