...
echo form_open('schools/special_order_entry/save_participant', array('id' => 'formParticipant'));
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
    ...
    <tr>
		...
		<?php 
		echo form_dropdown("cmbParticipant", $participants, @$selected_user[0]['rev_district_code'], 'id="cmbParticipant" ');
		?>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <?php 
    ...
    <tr>
    	<td colspan="4" style="padding:0; margin:0">
        	<div id="newEntry" style="display:<?php echo ( count( @$selected_participant ) > 0 ) ? 'block' : 'none';?>">
            	<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab">
                    <tr>
                        ...
                        <td align="left" width="30%" class="table_row_first"><?php echo form_input("txtADNO", @$selected_participant[0]['admn_no'], 'class="input_box" id="txtADNO" maxlength="5" onkeyup="javascript:this.value=this.value.toUpperCase();"');?></td>
                        <td align="left" colspan="2" class="table_row_first">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="30%" class="table_row_first">
                        <?php echo form_dropdown("txtGender", array('B' => 'Boy', 'G' => 'Girl'), @$selected_participant[0]['gender'],'id="txtGender"');?>
                        </td>
                        <td align="left" colspan="2" class="table_row_first">&nbsp;</td>
                    </tr>
				</table>
    ...
    <tr>
        ...
        <td align="left" width="80%" colspan="3" class="table_row_first">
            ...
            echo '<div style="margin-left:5px; float:left">'.form_input("txtItemCode_1", @$selected_participant[0]['item_code'], 'class="input_box_small" maxlength="4" id="txtItemCode_1" onkeypress="javascript:return numbersonly(this, event, false);"').'</div>';
			echo '<div style="margin-left:5px; float:left"> &nbsp; &nbsp; &nbsp; Captain Admission No : ';
			echo form_input("txtCaptionAdNo", @$selected_participant[0]['parent_admn_no'], 'class="input_box" maxlength="6" id="txtCaptionAdNo" onkeyup="javascript:this.value=this.value.toUpperCase();"').'</div>';
            ?>
            &nbsp; &nbsp; &nbsp;
            <?php 
			$checked =	'';
    ...
    <tr>
		...
		<td align="left" width="30%" class="table_row_first">
		<?php 
		echo form_textarea("txtRemarks", @$selected_user[0]['rev_district_code'], 'id="txtRemarks" style="width:450px; height:100px;" ');
		?>
        </td>
		<td align="left" colspan="2" class="table_row_first">&nbsp;</td>
	</tr>
		...
		for($j = 0; $j < count($participant_details); $j++){
			...
			<tr>
			   ...
			   <?php if ($captain_set){?>
                ...
                <?php if ($captain_set){?>
				<td align="center" class="<?php echo $classname?>" rowspan="<?php echo $caption_rowspan?>"> 
					<a href="javascript:void(0)" onClick="javascript:deleteSpecialOrderParticipant('<?php echo $participant_details[$j]['parent_admn_no']?>', '<?php echo $participant_details[$j]['item_code']?>')">
