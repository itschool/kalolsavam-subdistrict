...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
	...
	<tr>
        ...
        <td align="left" width="50%" colspan="2" class="table_row_second">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Time :
            <?php echo form_dropdown("txtHour", @$hour_array,(@$hour != '') ? $hour :'HH', 'class="input_box_medium" id="txtHour" maxlength="2" onfocus="javascript:clearText(\'txtHour\', \'HH\')" onBlur="javascript:clearText(\'txtHour\', \'HH\')" onkeyup="javascript:change_text_max_to_focus(\'txtHour\', \'txtMin\', \'2\')"' );?>
