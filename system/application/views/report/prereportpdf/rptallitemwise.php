...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td  class="ety"align="left" style=" border-bottom:1px #000000; border-right:0px #000000; padding:2px;"'><?php echo wordwrap($itempart[$j]['school_code'].' - '.$itempart[$j]['school_name'],45,'<br>');?></td>
    </tr>
    <?php 
    }
    ?>
