...
<table width="100%" border="0" align="center">
 ...
 <table width="130%" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    <td align="left" class="ety" >&nbsp;&nbsp;<?php echo wordwrap($part_details[$j]['item_code'].'  '.$part_details[$j]['item_name'],40,'<br>');?></td>
    <td align="left" class="ety" >&nbsp;&nbsp;<?php  echo wordwrap($part_details[$j]['participant_name'],40,'<br>');?></td>
