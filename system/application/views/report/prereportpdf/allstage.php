...
<?php
        ...
        $count		=	0;
            ...
            foreach($stagedata as $data)
			{
					...
					?>
                    <tr><td class="style2" colspan="5" style="border-bottom:1px #000000; border-right:1px #000000;" align="center">Item on &nbsp;<?php echo $dater; ?></td></tr>
  <tr>
    <td class="style2" align="center" width='40' style="border-bottom:1px #000000; border-right:1px #000000; padding:2px;">Sl.No. </td>
    <td class="style2" align="left" width='300' style="border-bottom:1px #000000; border-right:1px #000000; padding:2px;">&nbsp;Item</td>
    ...
    <td class="style2" align="center" width='150' style="border-bottom:1px #000000; border-right:1px #000000; padding:2px;"> Tentative Time </td>
