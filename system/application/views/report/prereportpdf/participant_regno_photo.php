    ...
    <tr>
      ...
      <tr bgcolor="#CCCCCC">
	   ...
	   <tr>
     	 ...
     	 <tr>
      		<td align="right" colspan="2" class="style9" style="border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php echo 'Cluster '.$partcard[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard[$j]['stage_name'].' - '.$partcard[$j]['stage_desc'].'&nbsp; :  on  '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
   	 	</tr>
  			<?php
			}
			else{
   	 ...
   	 <tr>
    		<td colspan="2" class="style55" align="right"><?php echo 'Cluster '.$partcard[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard[$j]['stage_name'].' - '.$partcard[$j]['stage_desc'].'&nbsp; : on '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
    ...
    <tr>
      ...
      <tr bgcolor="#CCCCCC">
	   ...
	   <tr>
     	 ...
     	 <tr>
      		<td align="right" colspan="2" class="style9" style="border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php echo 'Cluster '.$partcard1[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard1[$j]['stage_name'].' - '.$partcard1[$j]['stage_desc'].'&nbsp; :  on  '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
   	 	</tr>
  			<?php
			}
			else{
   	 ...
   	 <tr>
    		<td colspan="2" class="style55" align="right"><?php echo 'Cluster '.$partcard1[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard1[$j]['stage_name'].' - '.$partcard1[$j]['stage_desc'].'&nbsp; : on '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
    ...
    <tr>
      ...
      <tr bgcolor="#CCCCCC">
	   ...
	   <tr>
     	 ...
     	 <tr>
      		<td align="right" colspan="2" class="style9" style="border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php echo 'Cluster '.$partcard2[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard2[$j]['stage_name'].' - '.$partcard2[$j]['stage_desc'].'&nbsp; :  on  '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
   	 	</tr>
  			<?php
			}
			else{
   	 ...
   	 <tr>
    		<td colspan="2" class="style55" align="right"><?php echo 'Cluster '.$partcard2[$j]['cluster_no'].' :&nbsp;&nbsp; '.$partcard2[$j]['stage_name'].' - '.$partcard2[$j]['stage_desc'].'&nbsp; : on '.$dat_itme;?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
