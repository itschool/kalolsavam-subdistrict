...
Stage: <?php echo $retdata[$j]['stage_name'].' '.datetophpmodel($retdata[$j]['stime']).' at '.timephpmodel($retdata[$j]['ttime']); ?> Maximum Time for item :<?php echo $retdata[$j]['max_time']; ?> <?php }}$prev_array=$clustarray;?>
