...
<table width="123%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
 ...
 <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" >
  <tr>
  <td width="50"  align="center"  class="tb" style="border-right:1px #000000; padding:2px;" >Sl.No.</td>
    <td width="280"  align="left"  class="tb" style="border-right:1px #000000; padding:2px;" >Item</td>
    <td width="100" align="center" class="tb" style="border-right:1px #000000; padding:2px;" >Time</td>
    <td width="100" align="center" class="tb" style="border-right:1px #000000; padding:2px;" >No. of Participants</td>
    <td width="100" align="left" class="tb" style="border-right:0px #000000; padding:2px;">Time for completion</td>
   </tr>
		<?php
		}
		$count++;
  ...
  <td align="left" class="ety" style="border-top:1px #000000; border-right:1px #000000; padding:2px;"><?php echo $allot[$j]['item_code'].' - '.$allot[$j]['item_name']; ?></td>
    ...
    <td align="left" class="ety" style="border-top:1px #000000; border-right:0px #000000; padding:2px;" ><?php echo $time; ?></td>
   </tr>
  		<?php
		    }
 		 ?>
