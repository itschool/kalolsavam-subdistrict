...
<page_header>
        ...
        <tr>
            <td align="left" width="400" class="style1"  style=" padding:2px;">&nbsp;&nbsp;<?php echo $itemcode;?>-<?php echo $retdat[0]['item_name'];?>(<?php echo  $retdat[0]['fest_name'];?>) 
               &nbsp;&nbsp;<? echo "Result No - ".$result_no[0]['result_no'] ?>&nbsp;  </td>
