...
<?php echo form_open('report/prereportpdf/cluster_date_stage', array('id' => 'clust','target'=>'_blank'));
echo blue_box_top();
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <tr>
    ...
    <td align="left" width="55%" class="table_row_first">
       ...
       <?php echo form_submit('Report_for_press', 'Report For Press', 'onClick="javascript: return cluster_doc_date_stage()"'); ?>
    </td>
    <td width="18%">&nbsp;</td>
  </tr>
