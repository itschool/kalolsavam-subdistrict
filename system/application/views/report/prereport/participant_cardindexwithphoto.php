...
<br />
<?php echo form_open('report/prereportpdf/participant_cardindex2', array('id' => 'formPWD','target'=>'_blank'));
echo blue_box_top();
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th colspan="4" align="left"><strong>Participants Cards - District Wise</strong></th>
  </tr>
  <tr>
   
    <td width="20%" align="left" class="table_row_first"><strong> &nbsp;District  :</strong></td>
    <td width="24%" align="left" class="table_row_first"><?php echo form_dropdown("cboDistCode", $dist_array,$this->input->post('cboDistCode'), 'class="input_box" id="cboDistCode"'); ?> </td>
