...
<table width="100%" border="0" cellspacing="0" cellpadding="6" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <tr>
    <th width="3%" class="table_row_first">Slno</th>
    <th width="4%" class="table_row_first">Is Printed?</th>
    <th width="41%" class="table_row_first">&nbsp;&nbsp;&nbsp;Item Code & Name  </th>
    <th align="center" width="5%" class="table_row_first">Item Type</th>
    <th align="center" width="9%" class="table_row_first"> No.Students</th>
    <th align="center" width="9%" class="table_row_first">Participation</th>
	<th align="center" width="9%" class="table_row_first">Non-Participation</th>
	<th align="center" width="5%" class="table_row_first">A Grade</th>
	<th align="center" width="5%" class="table_row_first">B Grade</th>
 ...
 <?php
	...
	?>
		<tr>
		  <td width="3%" class="table_row_first"><?php echo $slno;?></td>
		  <td width="4%" class="table_row_first"><?php echo $printed;?></td>
			<td width="41%" class="table_row_first">
				&nbsp;&nbsp;
